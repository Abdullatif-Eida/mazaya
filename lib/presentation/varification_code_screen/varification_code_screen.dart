            ...
            body: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                  ...
                  Padding(
                      padding: getPadding(top: 16),
                      child:
                          Text("أدخل الرمز".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUITextSemibold27)),
                  Container(
                      width: getHorizontalSize(338),
                      margin: getMargin(top: 16),
                      child:
                          Text("أدخل الرمز الموجود في نص الرسالة المرسلة".tr, maxLines: null, textAlign: TextAlign.center, style: AppStyle.txtBody)),
                  Padding(
