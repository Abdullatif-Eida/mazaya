        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                            CustomAppBar(
                                ...
                                leading: AppbarImage(
                                    ...
                                    margin: getMargin(left: 0, top: 17, bottom: 25),
                                    onTap: onTapArrowleft),
                                title: AppbarTitle(text: "ابحث".tr, margin: getMargin(left: 16, bottom: 24, top: 16))),
                            Padding(
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                                  Expanded(
                                      child: CustomTextFormField(
                                          ...
                                          prefix: Container(
                                              margin: getMargin(left: 16, top: 12, right: 16, bottom: 12),
                                              child: CustomImageView(svgPath: ImageConstant.imgContrast)),
                                  ...
                                  Padding(
                                      ...
                                      child: Text("الغاء".tr,
                                          overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUITextRegular15Red500))
                                ]))
                          ]))),
                  // Container(
                  //     width: double.maxFinite,
                  ...
                  //                   },
                  //                   itemCount: controller.searchModelObj.value.searchItemList.length,
                  //                   itemBuilder: (context, index) {
                  //                     SearchItemModel model = controller.searchModelObj.value.searchItemList[index];
                  ...
                  //     child: Container(
                  //         margin: getMargin(top: 10),
                  //         padding: getPadding(left: 18, top: 16, right: 18, bottom: 16),
                  //         decoration: AppDecoration.white,
                  //         child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  //           Padding(
                  ...
                  //                     margin: getMargin(left: 16, top: 22, bottom: 21),
                  //                     child:
                  ...
                  //                 Spacer(),
                  //                 CustomImageView(
                  //                     svgPath: ImageConstant.imgStar, height: getSize(15), width: getSize(15), margin: getMargin(top: 38, bottom: 37))
                  //               ]))
                  //         ]))),
                  ...
                  //             Text("lbl_centrino".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtHeadline),
                  //             Padding(
