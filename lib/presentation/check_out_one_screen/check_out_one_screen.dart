    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarTitle(text: "lbl_check_out".tr, margin: getMargin(left: 16)),
                                    ...
                                    Container(
                                        ...
                                        child: Stack(alignment: Alignment.centerRight, children: [
                                          Align(
                                              alignment: Alignment.bottomCenter,
                                              child: Padding(
                                                  padding: getPadding(bottom: 11, top: 13),
                                                  child: SizedBox(
                                                      width: getHorizontalSize(341),
                                                      child: Divider(thickness: getVerticalSize(2), color: ColorConstant.gray300)))),
                                          Align(
                                              ...
                                              child: Container(
                                                  ...
                                                  height: getSize(24),
                                                  decoration:
                                                      AppDecoration.txtFillGray10001.copyWith(borderRadius: BorderRadiusStyle.txtCircleBorder12),
                                                  child: Text("lbl_3".tr,
                              ...
                              children: [
                                          ...
                                          child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                                            GestureDetector(
                                              ...
                                              child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                ...
                                                Padding(
                                                    padding: getPadding(left: 16, top: 10, bottom: 8),
                                                ...
                                                Spacer(),
                                                CustomImageView(
                                                    svgPath: controller.expand.value
                                                        ? ImageConstant.imgArrowup
                                                        : ImageConstant.imagePath + "down_arrow.svg",
                                                    height: getSize(24),
                                                    width: getSize(24),
                                                    margin: getMargin(top: 8, bottom: 8))
                                              ]),
                                                                    ...
                                                                    child: Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          CustomTextFormField(
                                                                              width: getHorizontalSize(186),
                                                                              focusNode: FocusNode(),
                                                                              controller: controller.group149Controller,
                                                                              hintText: "lbl_cvv".tr,
                                                                              margin: getMargin(top: 8),
                                ...
                                Padding(
                                    ...
                                    child: Obx(() => ListView.separated(
                                        ...
                                        itemCount: controller.checkOutOneModelObj.value.checkoutoneItemList.length,
                                        itemBuilder: (context, index) {
                                          CheckoutoneItemModel model = controller.checkOutOneModelObj.value.checkoutoneItemList[index];
