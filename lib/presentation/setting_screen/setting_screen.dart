        ...
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                leading: AppbarImage(
                    ...
                    margin: getMargin(left: 10, top: 17, bottom: 17),
                    onTap: onTapArrowleft15),
                title: AppbarTitle(text: "الإعدادات".tr, margin: getMargin(left: 16)),
                ...
                child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Container(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Padding(
                            padding: getPadding(left: 15, top: 4, bottom: 1),
                            child: Text("اللغة ".tr,
                                overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUITextRegular15Black900)),
                        Spacer(),
                        CustomImageView(svgPath: ImageConstant.imgArrowright, height: getSize(24), width: getSize(24))
                  ...
                  Container(
                      ...
                      decoration: AppDecoration.white,
                      child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        CustomImageView(svgPath: ImageConstant.imgQuestion, height: getSize(24), width: getSize(24)),
                        Padding(
