    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarTitle(text: "lbl_order_details".tr, margin: getMargin(left: 16)),
                    ...
                    child: Padding(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                          Obx(() => ListView.separated(
                              ...
                              itemCount: controller.orderDetailsOneModelObj.value.listorderid65254524oneItemList.length,
                              itemBuilder: (context, index) {
                                Listorderid65254524oneItemModel model =
                                    controller.orderDetailsOneModelObj.value.listorderid65254524oneItemList[index];
                                return Listorderid65254524oneItemWidget(model);
                              })),
                          Container(
                                                  ...
                                                  child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        Container(
                                                            ...
                                                            margin: getMargin(top: 7, right: 111),
                                                            child: Text("msg_4517_washington".tr,
                                                                maxLines: null, textAlign: TextAlign.left, style: AppStyle.txtBody))
                                                      ]))),
                                          CustomImageView(
                                              svgPath: ImageConstant.imgCheckmarkWhiteA700,
                                              height: getVerticalSize(8),
                                              width: getHorizontalSize(12),
                                              margin: getMargin(left: 42, top: 107))
                                        ])),
                                Align(
                                    ...
                                    child: Container(
                                        ...
                                        child: Column(
                                            ...
                                            children: [
                                              ...
                                              Container(
                                                  ...
                                                  child: Stack(alignment: Alignment.topLeft, children: [
                                                    CustomImageView(
                                                        ...
                                                        margin: getMargin(left: 22, bottom: 46)),
                                                    Align(
                                                    ...
                                                    Align(
                                                        ...
                                                        child: Container(
                                                            ...
                                                            decoration: BoxDecoration(
                                                                image: DecorationImage(image: fs.Svg(ImageConstant.imgGroup131), fit: BoxFit.cover)),
                                                            child: Column(
                                                                mainAxisSize: MainAxisSize.min,
                                                                crossAxisAlignment: CrossAxisAlignment.start,
                                              ...
                                              Padding(
                                                  ...
                                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    Padding(
                                                        ...
                                                        child: Text("lbl_delivery_free".tr,
                                                            overflow: TextOverflow.ellipsis,
                                                            textAlign: TextAlign.left,
                                              ...
                                              CustomButton(height: getVerticalSize(48), text: "lbl_view_invoice".tr, margin: getMargin(top: 32)),
                                              Align(
                                                  alignment: Alignment.center,
                                                  child: Padding(
                                                      ...
                                                      child: SizedBox(
                                                          ...
                                                          child: Divider(thickness: getVerticalSize(5), color: ColorConstant.black900))))
                                            ])))
                              ]))
                        ]))))));
  }
