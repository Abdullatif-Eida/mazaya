    ...
    return SafeArea(
        child: Scaffold(
            ...
            appBar: CustomAppBar(
                ...
                title: AppbarTitle(text: "lbl_select_address".tr, margin: getMargin(left: 16, top: 16, bottom: 16)),
                                          ...
                                          child: Container(
                                              ...
                                              child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                      color: ColorConstant.whiteA700, borderRadius: BorderRadius.circular(getHorizontalSize(5))))))
                                    ])),
                                Padding(
                            ...
                            Column(
                              children: [
                                ...
                                CustomButton(
                                    ...
                                    margin: getMargin(left: 20, top: 16, right: 20, bottom: 104),
