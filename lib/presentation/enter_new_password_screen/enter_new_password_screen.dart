            ...
            body: Form(
                ...
                child: Container(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.start, children: [
                      ...
                      Padding(
                          padding: getPadding(top: 16),
                          child: Text("أدخل كلمة السر الجديدة".tr,
                              overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtSFUITextSemibold27)),
                      Padding(
                          padding: getPadding(top: 40),
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                            Text("كلمة السر".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtBodyBlack900),
                            Obx(() => CustomTextFormField(
                                ...
                                suffix: GestureDetector(
                                    ...
                                    child: Container(
                                        ...
                                        child:
                                            CustomImageView(svgPath: controller.isShowPassword.value ? ImageConstant.imgEye : ImageConstant.imgEye))),
                      ...
                      Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                            Text("أكد كلمة السر".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtBodyBlack900),
                            Obx(() => CustomTextFormField(
                                focusNode: FocusNode(),
