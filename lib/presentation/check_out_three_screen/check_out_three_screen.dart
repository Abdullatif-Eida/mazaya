  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: CustomAppBar(
            ...
            title: AppbarTitle(text: "الطلبات السابقة".tr, margin: getMargin(left: 16)),
        ...
        body: Container(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  child: Align(
                      ...
                      child: Container(
                          ...
                          child: Column(
                              ...
                              children: [
                                Text("رقم الطلب 4156456".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtHeadline),
                                Padding(
                                    padding: getPadding(top: 8),
                                    child: Text("تاريخ الطلب: 1-1-2020".tr,
                                ...
                                Padding(
                                    ...
                                    child: Obx(() => ListView.separated(
                                        ...
                                        itemCount: controller.checkOutThreeModelObj.value.listpngeggoneItemList.length,
                                        itemBuilder: (context, index) {
                                          ListpngeggoneItemModel model = controller.checkOutThreeModelObj.value.listpngeggoneItemList[index];
                                          return ListpngeggoneItemWidget(model);
                                        }))),
                                Padding(
                                    padding: getPadding(top: 24),
                                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      // Expanded(
                                      //     child: CustomButton(height: getVerticalSize(48), text: "lbl_recoder".tr, margin: getMargin(left: 8)))
                                    ]))
                              ])))),
              // Container(
              //     width: double.maxFinite,
              ...
              //           Text("msg_order_id_5485124".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtHeadline),
              //           Padding(
              //               padding: getPadding(top: 8),
              ...
              //                                 imagePath: ImageConstant.imgPngegg13,
              ...
              //                                     color: ColorConstant.deepOrange50, borderRadius: BorderRadius.circular(getHorizontalSize(8))),
              ...
              //                             ]))
              //                   ]),
              //                   Text("lbl_qty_12".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtBodyBlack900)
              //                 ],
              //               )),
              //           CustomButton(
              //               onTap: () {
              ...
              Padding(
                  ...
                  child: SizedBox(width: getHorizontalSize(135), child: Divider(thickness: getVerticalSize(5), color: ColorConstant.black900)))
            ])));
  }
